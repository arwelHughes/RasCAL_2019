...
[refErr_95, sldErr_95, outMessage_95] = refPredInterval_2(chain,ref.bestFits,ref.bestSlds,intervals_95,95);

disp('Calculating 65% predicion intervals..'); 
[refErr_65, sldErr_65, outMessage_65] = refPredInterval_2(chain,ref.bestFits,ref.bestSlds,intervals_65);

disp('Calculating 25% predicion intervals..'); 
[refErr_25, sldErr_25, outMessage_25] = refPredInterval_2(chain,ref.bestFits,ref.bestSlds,intervals_25,25);
