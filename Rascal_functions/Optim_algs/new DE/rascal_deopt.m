...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function FVr_bestmem = rascal_deopt(fname,problem,PlotIt)

%[FVr_bestmem,S_bestval,I_nfeval]

%-----This is just for notational convenience and to keep the code uncluttered.--------

S_struct = problem.S_struct;
stopflag = 0;
addInfoText('***Starting Differential Evolution***');
...
%-----Select which vectors are allowed to enter the new population------------
  for k=1:I_NP
      ...
      S_tempval = feval(fname,FM_ui(k,:),problem);   % check cost of competitor
      I_nfeval  = I_nfeval + 1;
